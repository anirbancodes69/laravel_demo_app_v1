...
<section class="ed-2-banner bg-edoffwhite pt-[120px] pb-[190px] relative z-[1] overflow-hidden">
        ...
        <div class="flex md:flex-col gap-x-[112px] gap-y-[40px] items-center">
            ...
            <div class="max-w-[49%] xxxl:max-w-[45.5%] md:max-w-full shrink-0">
                ...
                <h1
                    ...
                    Explore Your Skills With <span class="font-bold"><span
                        ...
                        Class</span></h1>
                <p class="text-edgray font-medium mb-[41px]">Smply dummy text of the printing and typesetting
            ...
            <div class="max-w-[51%] md:max-w-full">
                <div class="w-max relative z-[1] flex gap-[30px] items-center">
                    <img src="{{ asset('/') }}assets/img/banner-2-img-1.jpg" alt="banner image"
                        class="border-[10px] border-white rounded-[20px] max-w-[241px] aspect-[261/366]">
                    <img src="{{ asset('/') }}assets/img/banner-2-img-2.jpg" alt="banner image" class="rounded-[20px]">
                    ...
                    <div>
                        ...
                        <img src="{{ asset('/') }}assets/img/banner-2-img-vector-1.svg" alt="vector"
                            class="pointer-events-none absolute -z[1] top-[30px] -left-[35px]">
                        <img src="{{ asset('/') }}assets/img/banner-2-img-vector-2.svg" alt="vector"
    ...
    <!-- vector -->
    <div>
        <img src="{{ asset('/') }}assets/img/banner-2-vector-1.svg" alt="vector"
            class="pointer-events-none absolute -z-[1] top-[135px] left-[38px] xxxl:hidden">
        <img src="{{ asset('/') }}assets/img/banner-2-vector-2.svg" alt="vector"
            class="pointer-events-none absolute -z-[1] bottom-0 left-0">
        <img src="{{ asset('/') }}assets/img/banner-2-vector-3.svg" alt="vector"
        ...
        <div
            ...
            <div class="ed-2-single-course mix personal-skill border border-[#e5e5e5] rounded-[10px] p-[20px] group">
                ...
                <div class="relative overflow-hidden rounded-[10px] mb-[24px]">
                    <img src="{{ asset('/') }}assets/img/course-1.jpg" alt="Course Image"
                    ...
                    <span
                        ...
                        <span class="icon"><img src="{{ asset('/') }}assets/img/icon/clock.svg" alt="icon"></span>
                ...
                <div class="flex flex-wrap items-center gap-x-[30px] gap-y-[10px]">
                    <div class="flex items-center gap-[8px] text-[14px] text-edgray">
                        <span class="icon"><img src="{{ asset('/') }}assets/img/icon/user-group.svg" alt="icon"></span>
                        <span class="txt">169 Students</span>
                    </div>

                    <div class="flex items-center gap-[8px] text-[14px] text-edgray">
                        <span class="icon"><img src="{{ asset('/') }}assets/img/icon/lesson.svg" alt="icon"></span>
                ...
                <div
                    ...
                    <div class="flex items-center gap-[8px]">
                        <img src="{{ asset('/') }}assets/img/user.png" alt="Course Author Image"
            ...
            <div
                ...
                <!-- course image  -->
                <div class="relative overflow-hidden rounded-[10px] mb-[24px]">
                    <img src="{{ asset('/') }}assets/img/course-2.jpg" alt="Course Image"
                        class="aspect-[330/223] w-full object-cover group-hover:scale-110">
                    <span
                        class="absolute bg-edyellow px-[10px] h-[33px] flex gap-[8px] items-center top-[16px] left-[16px] rounded-[6px]">
                        <span class="icon"><img src="{{ asset('/') }}assets/img/icon/clock.svg" alt="icon"></span>
            ...
            <div class="ed-2-single-course mix ui-ux-design border border-[#e5e5e5] rounded-[10px] p-[20px] group">
                <!-- course image  -->
                <div class="relative overflow-hidden rounded-[10px] mb-[24px]">
                    <img src="{{ asset('/') }}assets/img/course-3.jpg" alt="Course Image"
                        class="aspect-[330/223] w-full object-cover group-hover:scale-110">
                    <span
                        class="absolute bg-edyellow px-[10px] h-[33px] flex gap-[8px] items-center top-[16px] left-[16px] rounded-[6px]">
                        <span class="icon"><img src="{{ asset('/') }}assets/img/icon/clock.svg" alt="icon"></span>
            ...
            <div class="ed-2-single-course mix finance border border-[#e5e5e5] rounded-[10px] p-[20px] group">
                <!-- course image  -->
                <div class="relative overflow-hidden rounded-[10px] mb-[24px]">
                    <img src="{{ asset('/') }}assets/img/course-4.jpg" alt="Course Image"
                        class="aspect-[330/223] w-full object-cover group-hover:scale-110">
                    <span
                        class="absolute bg-edyellow px-[10px] h-[33px] flex gap-[8px] items-center top-[16px] left-[16px] rounded-[6px]">
                        <span class="icon"><img src="{{ asset('/') }}assets/img/icon/clock.svg" alt="icon"></span>
        ...
        <div class="flex md:flex-col gap-x-[75px] gap-y-[30px]">
            ...
            <div class="max-w-[46%] md:max-w-full grow shrink-0">
                <div class="relative flex items-end">
                    <img src="{{ asset('/') }}assets/img/about-2-image-1.png" alt="About Image"
                    ...
                    <div class="relative shrink-0 -ml-[202px] lg:-ml-[262px] md:-ml-[202px] xs:-ml-[242px] -mb-[24px]">
                        <img src="{{ asset('/') }}assets/img/about-2-image-2.png" alt="About Image"
                    ...
                    <!-- vectors -->
                    <div>
                        <img src="{{ asset('/') }}assets/img/about-2-img-vector.svg" alt="vector"
                            class="absolute pointer-events-none top-[60px] right-[65px] -z-[1]">
                        <img src="{{ asset('/') }}assets/img/about-2-img-vector-2.svg" alt="vector"
                ...
                <div class="swiper-slide w-[50%]">
                    <div class="space-y-[30px]">
                        ...
                        <div
                            ...
                            <!-- img -->
                            <div class="relative">
                                <img src="{{ asset('/') }}assets/img/event-4.jpg" alt="event cover"
                                ...
                                <span
                                    ...
                                    <span class="icon"><img src="{{ asset('/') }}assets/img/icon/convoc-cap.svg"
                                            alt="icon"></span>
                                    <span>Skills</span>
                                </span>
                            </div>
                            ...
                            <div>
                                <div class="flex items-center gap-[10px] font-medium text-[#808080] mb-[6px]">
                                    <span class="icon"><img src="{{ asset('/') }}assets/img/icon/clock-fill-yellow.svg"
                                            alt="icon"></span>
                                    <span>11:00 - 13:30</span>
                                </div>
                                <h5 class="font-semibold text-[20px] text-edblue mb-[4px]"><a href="event-details.html"
                                        class="hover:text-edpurple">Learning
                        ...
                        <div
                            ...
                            <!-- img -->
                            <div class="relative">
                                <img src="{{ asset('/') }}assets/img/event-2.jpg" alt="event cover"
                                    class="max-w-[215px] aspect-[215/203] object-cover rounded-[10px]">
                                <!-- category -->
                                <span
                                    ...
                                    <span class="icon shrink-0"><img
                                            src="{{ asset('/') }}assets/img/icon/convoc-cap.svg" alt="icon"></span>
                ...
                <div class="swiper-slide w-[50%]">
                    <div class="space-y-[30px]">
                        ...
                        <div
                            ...
                            <!-- img -->
                            <div class="relative">
                                <img src="{{ asset('/') }}assets/img/event-3.jpg" alt="event cover"
                                    class="max-w-[215px] aspect-[215/203] object-cover rounded-[10px]">
                                <!-- category -->
                                <span
                                    class="absolute bottom-0 left-[50%] -translate-x-[50%] inline-flex items-center gap-[8px] bg-edyellow px-[12px] h-[35px] text-edblue font-medium text-[14px] rounded-tr-[8px] rounded-tl-[8px]">
                        ...
                        <div
                            ...
                            <!-- img -->
                            <div class="relative">
                                <img src="{{ asset('/') }}assets/img/event-1.jpg" alt="event cover"
                                    class="max-w-[215px] aspect-[215/203] object-cover rounded-[10px]">
                                <!-- category -->
                                <span
                                    class="absolute w-max max-w-full bottom-0 left-[50%] -translate-x-[50%] inline-flex items-center gap-[8px] bg-edyellow px-[12px] h-[35px] text-edblue font-medium text-[14px] rounded-tr-[8px] rounded-tl-[8px]">
    ...
    <div class="mx-[19.7%] xxxl:mx-[14.7%] xxl:mx-[9.7%] xl:mx-[3.2%] md:mx-[15px]">
        <div class="flex md:flex-col gap-y-[15px] items-center justify-between">
            ...
            <div class="max-w-[600px] md:max-w-full shrink-0 relative">
                ...
                <!-- vector -->
                <img src="{{ asset('/') }}assets/img/cta-2-txt-vector.svg" alt="vector"
                    class="absolute bottom-[10px] left-[37%] xs:left-[75%]">
            </div>

            <!-- image -->
            <div class="mr-[40px] lg:mr-0 relative z-[1] shrink-0">
                <img src="{{ asset('/') }}assets/img/cta-2-img.png" alt="image">
                <!-- vector -->
                <div
...
<section class="py-[120px] xl:py-[80px] md:py-[60px] relative z-[1] overflow-hidden">
        ...
        <div class="grid grid-cols-2 md:grid-cols-1 gap-x-[60px] gap-y-[25px] items-center">
            ...
            <div class="grow shrink-0">
                <div class="relative flex items-end md:justify-center mb-[140px]">
                    <img src="{{ asset('/') }}assets/img/faq-2-img-1.jpg" alt="About Image"
                        class="border-[8px] border-white rounded-[8px] shrink-0">
                    <img src="{{ asset('/') }}assets/img/faq-2-img-2.jpg" alt="About Image"
                    ...
                    <div>
                        ...
                        <img src="{{ asset('/') }}assets/img/faq-img-vector.svg" alt="vector"
                ...
                <div class="ed-accordion space-y-[20px]">
                    ...
                    <div
                        ...
                        <div class="ed-single-accordion-item__body">
                            <p class="font-light text-[16px] text-etGray">Nullam faucibus eleifend mi eu varius.
                                Integer vel tincidunt massa, quis semper odio. Mauris et mollis quam. Nullam
                                fringilla erat id ante commodo sodales. In maximus ultrices euismod. Vivamus
                                porta justo ex.</p>
                        </div>
                    </div>
    ...
    <!-- vector -->
    <img src="{{ asset('/') }}assets/img/faq-2-vector.svg" alt="vector"
...
<section class="bg-edoffwhite py-[120px] xl:py-[80px] md:py-[60px] relative z-[1] overflow-hidden">
    <div class="mx-[19.7%] xxxl:mx-[14.7%] xxl:mx-[9.7%] xl:mx-[3.2%] md:mx-[15px]">
        ...
        <div class="grid grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 xxs:grid-cols-1 gap-[30px] md:gap-[15px]">
            ...
            <div class="text-center group">
                ...
                <div class="relative mb-[18px] overflow-hidden rounded-[12px]">
                    <img src="{{ asset('/') }}assets/img/instructor-1.jpg" alt="instructor image"
                ...
                <!-- txt -->
                <div>
                    <h6 class="font-semibold text-[18px] text-edblue mb-[12px]"><a href="teacher-details.html"
                            class="hover:text-edyellow">Brooklyn Simmons</a></h6>
            ...
            <div class="text-center group">
                <!-- img -->
                <div class="relative mb-[18px] overflow-hidden rounded-[12px]">
                    <img src="{{ asset('/') }}assets/img/instructor-2.jpg" alt="instructor image"
                        class="w-full aspect-[270/320] object-cover group-hover:scale-110">
                    <!-- socials -->
                    <div class="et-member-socials absolute right-[20px] md:right-[15px] top-[20px] md:top-[15px] z-[1]">
                        <div
                ...
                <div>
                    <h6 class="font-semibold text-[18px] text-edblue mb-[12px]"><a href="teacher-details.html"
                            class="hover:text-edyellow">Leslie Alexander</a></h6>
            ...
            <div class="text-center group">
                <!-- img -->
                <div class="relative mb-[18px] overflow-hidden rounded-[12px]">
                    <img src="{{ asset('/') }}assets/img/instructor-3.jpg" alt="instructor image"
                        class="w-full aspect-[270/320] object-cover group-hover:scale-110">
                    <!-- socials -->
                    <div class="et-member-socials absolute right-[20px] md:right-[15px] top-[20px] md:top-[15px] z-[1]">
                        <div
                ...
                <div>
                    <h6 class="font-semibold text-[18px] text-edblue mb-[12px]"><a href="teacher-details.html"
                            class="hover:text-edyellow">Ronald Richards</a></h6>
            ...
            <div class="text-center group">
                <!-- img -->
                <div class="relative mb-[18px] overflow-hidden rounded-[12px]">
                    <img src="{{ asset('/') }}assets/img/instructor-4.jpg" alt="instructor image"
                        class="w-full aspect-[270/320] object-cover group-hover:scale-110">
                    <!-- socials -->
                    <div class="et-member-socials absolute right-[20px] md:right-[15px] top-[20px] md:top-[15px] z-[1]">
                        <div
                ...
                <div>
                    <h6 class="font-semibold text-[18px] text-edblue mb-[12px]"><a href="teacher-details.html"
                            class="hover:text-edyellow">Kristin Watson</a></h6>
        ...
        <div class="lg:hidden">
            ...
            <img src="{{ asset('/') }}assets/img/admission-vector-2.svg" alt="vector"
                class="absolute -z-[1] bottom-[154px] right-[58px]">
            <img src="{{ asset('/') }}assets/img/instructor-vector.svg" alt="vector"
...
<section class="py-[120px] xl:py-[80px] md:py-[60px] relative z-[1] overflow-hidden">
                        ...
                        <div class="swiper-slide w-[570px] lg:w-[540px] xs:w-full">
                            <div
                                ...
                                <div
                                    ...
                                    <img src="{{ asset('/') }}assets/img/user-2.png" alt="reviewer image"
                                        class="w-[70px] aspect-square rounded-full shrink-0">

                                    <div class="flex items-center justify-between grow xxs:w-full">
                                        <div class="left">
                                            <h5 class="text-edblue font-semibold text-[20px] mb-[1px]">Esther
                                                Howard</h5>
                                            <h6 class="text-[16px] text-edpurple font-normal">Nursing Assistant
                                            </h6>
                                        </div>

                                        <div class="right">
                                            <img src="{{ asset('/') }}assets/img/icon/quotation.svg"
                                                alt="quotation mark">
                                        </div>
                                    </div>
                                </div>

                                <p class="text-[#445375] font-normal mb-[21px]">Donec ac lacus placerata dolor
                                    duis consequat placerat sit amet a elit. In volutpat, lacus in egestas
                                    finibus nisi orci tincidunt risus, a dapibus </p>

                                <!-- rating stars -->
                                <div
                                    class="inline-flex items-center gap-[6px] border border-edyellow rounded-full px-[10px] h-[40px]">
                                    <img src="{{ asset('/') }}assets/img/icon/star.svg" alt="star">
                                    <img src="{{ asset('/') }}assets/img/icon/star.svg" alt="star">
                                    <img src="{{ asset('/') }}assets/img/icon/star.svg" alt="star">
                                    <img src="{{ asset('/') }}assets/img/icon/star.svg" alt="star">
                                    <img src="{{ asset('/') }}assets/img/icon/star.svg" alt="star">
    ...
    <!-- vector -->
    <img src="{{ asset('/') }}assets/img/testimonial-2-vector.svg" alt="vector"
    ...
    <div class="mx-[19.7%] xxxl:mx-[14.7%] xxl:mx-[9.7%] xl:mx-[3.2%] md:mx-[15px]">
        <div class="flex md:flex-wrap gap-[70px] lg:gap-[50px] *:flex-auto">
            ...
            <div
                ...
                <img src="{{ asset('/') }}assets/img/stat-1.png" alt="icon" class="w-max max-w-full mx-auto mb-[7px]">
            ...
            <div
                class="text-white text-center md:w-[45%] shrink-0 pr-[80px] lg:pr-[60px] last:pr-0 border-r border-white/20 last:border-0 md:even:pr-0 md:even:border-r-0 xs:pr-0 xs:border-r-0">
                <img src="{{ asset('/') }}assets/img/stat-2.png" alt="icon" class="w-max max-w-full mx-auto mb-[7px]">
            ...
            <div
                class="text-white text-center md:w-[45%] shrink-0 pr-[80px] lg:pr-[60px] last:pr-0 border-r border-white/20 last:border-0 md:even:pr-0 md:even:border-r-0 xs:pr-0 xs:border-r-0">
                <img src="{{ asset('/') }}assets/img/stat-3.png" alt="icon" class="w-max max-w-full mx-auto mb-[7px]">
            ...
            <div
                class="text-white text-center md:w-[45%] shrink-0 pr-[80px] lg:pr-[60px] last:pr-0 border-r border-white/20 last:border-0 md:even:pr-0 md:even:border-r-0 xs:pr-0 xs:border-r-0">
                <img src="{{ asset('/') }}assets/img/stat-4.png" alt="icon" class="w-max max-w-full mx-auto mb-[7px]">
    ...
    <div class="mx-[19.7%] xxxl:mx-[14.7%] xxl:mx-[9.7%] xl:mx-[3.2%] md:mx-[15px]">
        ...
        <div class="grid grid-cols-2 md:grid-cols-1 gap-[30px]">
            ...
            <div class="rounded-[20px] bg-edoffwhite overflow-hidden">
                <!-- img -->
                <div class="relative">
                    <img src="{{ asset('/') }}assets/img/blog-big.jpg" alt="blog cover" class="w-full aspect-[570/290]">
                    <!-- date -->
                    <div
                ...
                <div class="px-[30px] xxs:px-[20px] py-[22px] pt-[27px]">
                    ...
                    <div class="flex items-center gap-[16px] mb-[9px]">
                        ...
                        <div class="flex items-center gap-[10px] font-medium text-[12px] text-edgray">
                            <span><img src="{{ asset('/') }}assets/img/icon/user-filled-purple.svg" alt="icon"></span>
                            <span>By Admin</span>
                        </div>

                        <!-- single info -->
                        <div class="flex items-center gap-[10px] font-medium text-[12px] text-edgray">
                            <span><img src="{{ asset('/') }}assets/img/icon/comment.svg" alt="icon"></span>
                            <span>2 Comments</span>
                        </div>
                    </div>
                    <h5 class="font-medium text-[20px]"><a href="news-details.html"
                            class="hover:text-edpurple">Collaboratively pontificate bleeding edge resources with
                            inexpensive methodologies</a></h5>
                </div>
            </div>
            ...
            <div class="bg-edoffwhite rounded-[20px] p-[30px] xxs:p-[20px] space-y-[26px]">
                ...
                <div
                    ...
                    <div class="shrink-0 rounded-[10px] overflow-hidden">
                        <img src="{{ asset('/') }}assets/img/news-2-img-2.jpg" alt="blog cover"
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-[16px] mb-[9px]">
                            <!-- single info -->
                            <div class="flex items-center gap-[10px] font-medium text-[12px] text-edgray">
                                <span><img src="{{ asset('/') }}assets/img/icon/user-filled-purple.svg"
                                        alt="icon"></span>
                                <span>By Admin</span>
                            </div>
                ...
                <div
                    ...
                    <!-- img -->
                    <div class="shrink-0 rounded-[10px] overflow-hidden">
                        <img src="{{ asset('/') }}assets/img/news-2-img-3.jpg" alt="blog cover"
                            class="w-[142px] aspect-[142/153] object-cover">
                    </div>
...
<div class="mx-[19.7%] xxxl:mx-[14.7%] xxl:mx-[9.7%] xl:mx-[3.2%] md:mx-[15px]">
    <div class="ed-partners-slider swiper my-[100px] xl:my-[70px] md:my-[50px]">
        <div class="swiper-wrapper">
            <!-- single partner -->
            <div class="swiper-slide"><img src="{{ asset('/') }}assets/img/partner-1.png" alt="Partner Logo">
            </div>
            <!-- single partner -->
            <div class="swiper-slide"><img src="{{ asset('/') }}assets/img/partner-2.png" alt="Partner Logo">
            </div>
            <!-- single partner -->
            <div class="swiper-slide"><img src="{{ asset('/') }}assets/img/partner-3.png" alt="Partner Logo">
            </div>
            <!-- single partner -->
            <div class="swiper-slide"><img src="{{ asset('/') }}assets/img/partner-4.png" alt="Partner Logo">
            </div>
            <!-- single partner -->
            <div class="swiper-slide"><img src="{{ asset('/') }}assets/img/partner-5.png" alt="Partner Logo">
            </div>
            <!-- single partner -->
            <div class="swiper-slide"><img src="{{ asset('/') }}assets/img/partner-6.png" alt="Partner Logo">
            </div>
            <!-- single partner -->
            <div class="swiper-slide"><img src="{{ asset('/') }}assets/img/partner-1.png" alt="Partner Logo">
            </div>
